var joutguess={
	...
	run_command:function(cmd,getoutput){
		...
		this.jslinux.cin(10);
		if(typeof getoutput!=="undefined") this.ob_start();
		return callback;
	},
 ...
 // Prevent default behavior (Prevent file from being opened)
  ...
  if (ev.dataTransfer.items) {
	...
	prompt_hook:function(){
		if(!joutguess.ready_for_input) joutguess.ready_for_input_hook();
		if(this.prompt_callbacks.length<1) return;
	...
	ob_start:function(){ this.ob.buffer=""; this.ob.buffering=true; },
	ob_clean:function(){ this.ob.buffer=""; },
	ob_end:function(){ this.ob.buffering=false; return this.ob.buffer; },
	ob_get:function(){return this.ob.buffer; },
	startup:function(){
		this.jslinux.cin=Module.cwrap('console_queue_char', null, ['number']);
		this.jslinux.cout=Term.prototype.write;
		Term.prototype.write=function(arg){if(joutguess.cout_hook(arg)!==false) joutguess.jslinux.cout.call(this,arg); }
